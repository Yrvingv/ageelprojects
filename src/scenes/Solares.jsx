...
const VIDEO_WEBM = `${BASE}videos/solares-bg.webm`
const VIDEO_MP4  = `${BASE}videos/solares-bg.mp4`
const POSTER     = `${BASE}images/solares/hero-poster.png`

// Galería desde /public/gallery/solares (01.jpg … 22.jpg)
const GALLERY_COUNT = 22
const GALLERY_EXT = 'jpg'
const gallery = Array.from({ length: GALLERY_COUNT }, (_, i) =>
  `${BASE}gallery/solares/${String(i + 1).padStart(2, '0')}.${GALLERY_EXT}`
)

export default function Solares(){
  const svc = services.find(s=>s.slug==='paneles-solares')
  ...
  return (
    <section id="solares" className="scene relative scroll-mt-28 md:scroll-mt-32" aria-label="Paneles Solares">
      ...
      <div className="h-full w-full px-6 sm:px-8 md:pr-16 md:pl-[12rem] lg:pl-[13rem] xl:pl-[15rem] pt-28 md:pt-32 pb-12">
        <div className="grid gap-8 items-start md:grid-cols-2">
          ...
          <div className="flex flex-col">
            ...
            >
              Factibilidades técnica EDET y dimensionamiento honesto.
            </motion.p>
            ...
            <motion.div
              ...
              className="mt-8"
            >
              <a href="#solares" className="btn-primary">Pedir factibilidad EDET</a>
            </motion.div>
          </div>
      ...
      <span className="visually-hidden" aria-live="polite">Sección Solares</span>
    </section>
  )
}
